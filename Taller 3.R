...
#Corregimos los valores con notas (No funcionó la corrección en Markdown y tocó a mano)
...
load("./datos.Rdata")
#Probabilidad lineal
linreg <- lm (formula = ocupado ~ edad + sexo + area + lee + niveleduc_s + mes, data = datos) %>% summary()
